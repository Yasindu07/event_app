...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Keep your team and attendees informed with Mage's built-in messaging system. From event updates to last-minute changes, communication has never been easier.
        </p>
    </div>
</div>
